...
<head>
  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">The First Five Pages</a>
        </div>
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="#">Home</a></li>
            <li><a href="#nowReading">Now Reading</a></li>
    ...
    <a href="show_story">Show Story</a>


	{{ Form::open(array(
		'url' => '',
		'action' => 'StoryController@showStory'
	)) }}
    
	{{ Form::submit('Discover') }}
